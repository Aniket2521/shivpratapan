...
const Currentaccount = () => {
  ...
  const keyFeatures = [
    {
      ...
      description: 'High-value cash withdrawal for business needs',
      icon: <GiReceiveMoney />,
    ...
    },
    {
      ...
      description: 'Bulk cash deposit facility at branches',
      icon: <GiPayMoney />,
      color: 'from-emerald-600 to-emerald-800'
    },
    {
      marathi: 'अमर्यादित व्यवहार',
      english: 'Unlimited Transactions',
      description: 'No limits on number of transactions',
      icon: <FaExchangeAlt />,
      color: 'from-purple-600 to-purple-800'
    },
    {
      marathi: 'NEFT / RTGS / IMPS',
      english: 'Fund Transfer',
      description: 'Instant business fund transfers',
      icon: <FaGlobe />,
    ...
    },
    {
      marathi: 'चेक बुक',
      english: 'Cheque Book',
      description: 'Free business cheque book facility',
      icon: <FaCreditCard />,
      color: 'from-amber-600 to-amber-800'
    },
    {
      marathi: 'पासबुक / विवरणपत्र',
      english: 'Passbook & Statement',
      description: 'Monthly business statements',
      icon: <FaBook />,
  ...
  const businessBenefits = [
    { title: 'High Transaction Limits', icon: <FaChartLine />, desc: 'Higher limits for business operations' },
    { title: 'Business Debit Card', icon: <FaCreditCard />, desc: 'Special business debit card' },
    { title: 'Online Banking', icon: <FaMobileAlt />, desc: 'Full business banking online' },
    { title: 'Bulk Payment Facility', icon: <GiTakeMyMoney />, desc: 'Bulk payment processing' },
    { title: 'Tax Payments', icon: <FaBalanceScale />, desc: 'Direct tax payment facility' },
    { title: 'QR Code Payments', icon: <FaQrcode />, desc: 'Accept QR code payments' }
  ];

  // Business Types
  const businessTypes = [
    { type: 'proprietor', label: 'Proprietorship', icon: <FaUserTie /> },
    { type: 'partnership', label: 'Partnership Firm', icon: <FaHandshake /> },
    { type: 'company', label: 'Company', icon: <FaBuilding /> },
    { type: 'trust', label: 'Trust/Institution', icon: <FaUniversity /> },
    { type: 'llp', label: 'LLP', icon: <FaBriefcase /> }
  ];

  // Document requirements by business type
  const documentRequirements = {
    proprietor: [
      { doc: 'Aadhaar Card', mandatory: true },
      { doc: 'PAN Card', mandatory: true },
      { doc: 'Address Proof', mandatory: true },
      { doc: 'Business Registration', mandatory: true },
      { doc: 'GST Certificate', mandatory: false },
      { doc: 'Business Address Proof', mandatory: true }
    ],
    partnership: [
      { doc: 'Partnership Deed', mandatory: true },
      { doc: 'PAN of Firm', mandatory: true },
      { doc: 'Partners IDs', mandatory: true },
      { doc: 'Business Registration', mandatory: true },
      { doc: 'GST Certificate', mandatory: false },
      { doc: 'Address Proof', mandatory: true }
    ],
    company: [
      { doc: 'Certificate of Incorporation', mandatory: true },
      { doc: 'MOA & AOA', mandatory: true },
      { doc: 'PAN of Company', mandatory: true },
      { doc: 'Board Resolution', mandatory: true },
      { doc: 'Director IDs', mandatory: true },
      { doc: 'Company Address Proof', mandatory: true }
    ],
    trust: [
      { doc: 'Trust Deed', mandatory: true },
      { doc: 'Registration Certificate', mandatory: true },
      { doc: 'PAN of Trust', mandatory: true },
      { doc: 'Trustee IDs', mandatory: true },
      { doc: 'Resolution', mandatory: true },
      { doc: 'Address Proof', mandatory: true }
    ],
    llp: [
      { doc: 'LLP Agreement', mandatory: true },
      { doc: 'Certificate of Incorporation', mandatory: true },
      { doc: 'PAN of LLP', mandatory: true },
      { doc: 'Partners IDs', mandatory: true },
      { doc: 'Business Registration', mandatory: true },
      { doc: 'Address Proof', mandatory: true }
    ]
  ...
  const accountCharges = [
    { service: 'Minimum Balance', charge: '₹10,000', period: 'Quarterly' },
    { service: 'Cash Deposit (Other Bank)', charge: '₹5 per ₹1,000', period: 'Per Transaction' },
    { service: 'NEFT Transaction', charge: 'Free up to ₹10 lakhs', period: 'Daily' },
    { service: 'RTGS Transaction', charge: '₹25 + GST', period: 'Per Transaction' },
    { service: 'Cheque Book', charge: 'Free', period: 'Annual' },
    { service: 'Account Maintenance', charge: '₹1,500 + GST', period: 'Annual' }
  ];

  // Transaction Limits
  const transactionLimits = [
    { type: 'Cash Withdrawal', limit: '₹2,00,000', period: 'Daily' },
    { type: 'Cash Deposit', limit: '₹5,00,000', period: 'Daily' },
    { type: 'NEFT/RTGS', limit: '₹50,00,000', period: 'Daily' },
