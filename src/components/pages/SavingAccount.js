              ...
              <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-6 md:p-8 border border-gray-100">
                <div className="flex flex-col sm:flex-row items-start sm:items-center mb-4 sm:mb-6">
                  ...
                  <div className="text-center sm:text-left">
                    <h2 className="text-2xl sm:text-3xl font-bold text-gray-800">{t.aboutTitle}</h2>
                    <p className="text-gray-600 text-sm sm:text-base mt-1">{t.aboutSubtitle}</p>
                  </div>
                </div>
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-center p-3 bg-white rounded-lg border border-green-200">
                  ...
                  <div>
                    ...
                    <div className="text-green-700 font-bold text-sm sm:text-base">1800-123-4567</div>
                  </div>
                </div>
                <div className="flex items-center p-3 bg-white rounded-lg border border-green-200">
